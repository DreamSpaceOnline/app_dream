...
{
    public class UpperChannelCalculator : IndicatorCalculator
    {
        private readonly UpperChannel _calculator;

        public UpperChannelCalculator()
        {
            _calculator = new UpperChannel();
        }
