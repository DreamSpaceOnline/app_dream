...
define('components/market/jobs-dashboard/jobs-dashboard',["require", "exports", "tslib", "aurelia-framework", "../../../services/account-service"], function (require, exports, tslib_1, aurelia_framework_1, account_service_1) {
    "use strict";
    var JobsDashboard = (function () {
        function JobsDashboard(account) {
            this.powerUser = false;
            this.progress = 60;
            this.powerUser = account.currentUser.isAuthenticated;
        }
        JobsDashboard.prototype.refreshSP500Stocks = function () {
        };
        JobsDashboard.prototype.refreshAllStocks = function () {
        };
        JobsDashboard.prototype.RecalculateGlobalIndicators = function () {
        };
        return JobsDashboard;
    }());
    JobsDashboard = tslib_1.__decorate([
        aurelia_framework_1.autoinject(),
        tslib_1.__metadata("design:paramtypes", [account_service_1.AccountService])
    ], JobsDashboard);
    exports.JobsDashboard = JobsDashboard;
});
...
define('text!components/market/jobs-dashboard/jobs-dashboard.html', ['module'], function(module) { module.exports = "<template><require from=\"./jobs-dashboard.css\"></require><div class=\"row\"><div class=\"col-md-8 col-xs-12 c_dashboard\"><header><h3>Jobs Dashboard</h3></header></div><div class=\"col-md-4 col-xs-12\"><div class=\"side-navigation\"><h3>Jobs</h3><ul><li><span class=\"glyphicon glyphicon-arrow-right\" aria-hidden=\"true\"></span> <a click.delegate=\"RecalculateGlobalIndicators()\" title=\"Recalculate Global Indicators\" class=\"\">Recalculate Global Indicators</a></li><li><span class=\"glyphicon glyphicon-arrow-right\" aria-hidden=\"true\"></span> <a click.delegate=\"refreshSP500Stocks()\" title=\"Refresh S&P 500 Stocks\" class=\"\">Refresh S&P 500 Stocks</a></li><li><span class=\"glyphicon glyphicon-arrow-right\" aria-hidden=\"true\"></span> <a click.delegate=\"refreshAllStocks()\" title=\"Refresh All Stocks\" class=\"\">Refresh All Stocks</a></li></ul><h3>Running Jobs</h3><ul><li><a click.delegate=\"RecalculateGlobalIndicators()\" title=\"Recalculate Global Indicators\" class=\"\">Recalculate Global Indicators</a> <span class=\"glyphicon glyphicon-pause\" aria-hidden=\"true\"></span> <span class=\"glyphicon glyphicon-stop\" aria-hidden=\"true\"></span><s-progress progress.bind=\"progress\"></s-progress></li><li><a click.delegate=\"refreshSP500Stocks()\" title=\"Refresh S&P 500 Stocks\" class=\"\">Refresh S&P 500 Stocks</a> <span class=\"glyphicon glyphicon-pause\" aria-hidden=\"true\"></span> <span class=\"glyphicon glyphicon-stop\" aria-hidden=\"true\"></span></li><li><a click.delegate=\"refreshAllStocks()\" title=\"Refresh All Stocks\" class=\"\">Refresh All Stocks</a> <span class=\"glyphicon glyphicon-play\" aria-hidden=\"true\"></span> <span class=\"glyphicon glyphicon-book\" aria-hidden=\"true\"></span></li></ul></div></div></div></template>"; });
...
define('text!components/market/jobs-dashboard/jobs-dashboard.css', ['module'], function(module) { module.exports = ".c_dashboard {\n  background-color: rgba(255, 255, 255, 0.7);\n  padding-bottom: 15px;\n}\n"; });
