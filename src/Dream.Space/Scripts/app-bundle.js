    ...
    var App = (function () {
        ...
        App.prototype.configureRouter = function (config, router) {
            ...
            config.map([
                ...
                { route: ["global"], moduleId: "./components/market/navigation", name: "markets", title: "Global Markets", nav: true },
...
define('components/market/global-markets',["require", "exports", "tslib", "aurelia-framework", "../../services/account-service"], function (require, exports, tslib_1, aurelia_framework_1, account_service_1) {
    "use strict";
    var GlobalMarkets = (function () {
        function GlobalMarkets(account) {
            this.powerUser = false;
            this.powerUser = account.currentUser.isAuthenticated;
        }
        GlobalMarkets.prototype.refreshSP500Stocks = function () {
        };
        GlobalMarkets.prototype.refreshAllStocks = function () {
        };
        GlobalMarkets.prototype.recalculateSP500Indicators = function () {
        };
        return GlobalMarkets;
    }());
    GlobalMarkets = tslib_1.__decorate([
        aurelia_framework_1.autoinject(),
        tslib_1.__metadata("design:paramtypes", [account_service_1.AccountService])
    ], GlobalMarkets);
...
define('components/market/sub-nav/market-navigation',["require", "exports"], function (require, exports) {
    "use strict";
    var MarketNavigation = (function () {
        function MarketNavigation() {
            this.items = [];
        }
        return MarketNavigation;
    }());
    exports.MarketNavigation = MarketNavigation;
});

define('components/market/sub-nav/stock-indices',["require", "exports"], function (require, exports) {
    "use strict";
    var StockIndices = (function () {
    ...
    exports.StockIndices = StockIndices;
});
...
define('text!components/market/navigation.html', ['module'], function(module) { module.exports = "<template><require from=\"./sub-nav/stock-indices\"></require><stock-indices></stock-indices><div class=\"container page-content\"><router-view></router-view></div></template>"; });
define('text!components/market/sub-nav/strategy-navigation.html', ['module'], function(module) { module.exports = "<template><div class=\"sub-nav\"><nav class=\"navbar navbar\"><div class=\"container\"><nav class=\"navbar\"><ul class=\"nav navbar-nav\"><li repeat.for=\"item of items\" class=\"${item.isActive ? 'active' : ''}\"><a href.bind=\"item.url\">${item.title}</a></li></ul></nav></div></nav></div></template>"; });
define('text!components/market/global-markets.html', ['module'], function(module) { module.exports = "<template><require from=\"./global-markets.css\"></require><div class=\"actions\" if.bind=\"powerUser\"><div class=\"btn-group\" role=\"group\"><button type=\"button\" class=\"btn btn-danger dropdown-toggle\" data-toggle=\"dropdown\" aria-haspopup=\"true\" aria-expanded=\"false\">Administration <span class=\"caret\"></span></button><ul class=\"dropdown-menu\"><li><a click.delegate=\"refreshSP500Stocks()\">Refresh S&P500 Stocks</a></li><li><a click.delegate=\"refreshAllStocks()\">Refresh All Stocks</a></li><li role=\"separator\" class=\"divider\"></li><li><a click.delegate=\"recalculateSP500Indicators()\">Recalculate S&P500 Indicators</a></li></ul></div></div><h3>Global markets</h3></template>"; });
define('text!components/market/global-markets.css', ['module'], function(module) { module.exports = ""; });
define('text!components/market/sub-nav/market-navigation.html', ['module'], function(module) { module.exports = "<template><div class=\"sub-nav\"><nav class=\"navbar navbar\"><div class=\"container\"><nav class=\"navbar\"><ul class=\"nav navbar-nav\"><li repeat.for=\"item of items\" class=\"${item.isActive ? 'active' : ''}\"><a href.bind=\"item.url\">${item.title}</a></li></ul></nav></div></nav></div></template>"; });
define('text!components/market/sub-nav/stock-indices.html', ['module'], function(module) { module.exports = "<template><div class=\"sub-nav\"><nav class=\"navbar navbar\"><div class=\"container\"><nav class=\"navbar\"><ul class=\"nav navbar-nav\"><li repeat.for=\"item of items\" class=\"${item.isActive ? 'active' : ''}\"><a href.bind=\"item.url\">${item.title}</a></li></ul></nav></div></nav></div></template>"; });
