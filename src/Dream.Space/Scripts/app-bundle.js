...
define('components/market/jobs-dashboard/jobs/job',["require", "exports", "tslib", "aurelia-framework", "../../../../services/account-service", "../../../../services/job-service", "aurelia-event-aggregator"], function (require, exports, tslib_1, aurelia_framework_1, account_service_1, job_service_1, aurelia_event_aggregator_1) {
    "use strict";
    var Job = (function () {
...
define('services/job-services',["require", "exports"], function (require, exports) {
    "use strict";
...
define('services/job-service',["require", "exports"], function (require, exports) {
    "use strict";
...
define('text!components/market/jobs-dashboard/jobs/job.html', ['module'], function(module) { module.exports = "<template><require from=\"./job.css\"></require><require from=\"./job-details/job-details\"></require><header><h3>${title}</h3></header><h4>Current Job</h4><h4>History</h4><div class=\"c_job-details-list\"><job-details repeat.for=\"job of jobs\" job.bind=\"job\" class=\"${$index === $parent.jobs.length-1 ? 'no-border': ''}\"></job-details><div class=\"c_jod_details\"><div class=\"c_jod_details-header right\"><button type=\"button\" click.delegate=\"deleteAll()\" class=\"btn btn-warning btn-xs\">Clear</button></div></div></div></template>"; });
