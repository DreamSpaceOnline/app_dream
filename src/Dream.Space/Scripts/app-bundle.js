...
define('components/strategies/strategy-playground',["require", "exports", "tslib", "toastr", "aurelia-framework", "aurelia-event-aggregator", "./navigation", "../../services/strategy-service", "../../services/company-service", "../../services/stock-service", "../../services/playground-service", "../../services/settings-service"], function (require, exports, tslib_1, toastr, aurelia_framework_1, aurelia_event_aggregator_1, navigation_1, strategy_service_1, company_service_1, stock_service_1, playground_service_1, settings_service_1) {
    ...
    var StrategyPlayground = (function () {
        ...
        StrategyPlayground.prototype.buildProgressStyle = function (ruleSet) {
...
define('resources/elements/chart/stock-chart',["require", "exports", "tslib", "aurelia-framework", "aurelia-event-aggregator", "../../../common/types/playground-models"], function (require, exports, tslib_1, aurelia_framework_1, aurelia_event_aggregator_1, Playgroundmodels) {
    "use strict";
    var StockChart = (function () {
        function StockChart(eventAggregator) {
            this.eventAggregator = eventAggregator;
            this.subscriptions = [];
        }
        ...
        StockChart.prototype.attached = function () {
            var _this = this;
            this.subscriptions.push(this.eventAggregator.subscribe("StrategyPlayground.loadPrev", function (data) { return _this.loadPrev(data); }));
            this.subscriptions.push(this.eventAggregator.subscribe("StrategyPlayground.loadNext", function (data) { return _this.loadNext(data); }));
        ...
        StockChart.prototype.loadPrev = function (data) {
            this.playgroundData = data;
        };
        StockChart.prototype.loadNext = function (data) {
            this.playgroundData = data;
        };
        StockChart.prototype.drawChart = function () {
            ...
            this.model.periods.forEach(function (period) {
                ...
                period.quotes.forEach(function (item) {
                    var row = [[item.date, item.open, item.high, item.low, item.close]];
                ...
                var series = chart.plot(plotNumber).ohlc(mapping);
                ...
                period.indicators.forEach(function (indicator) {
                    var indicatorPlot = chart.plot(plotNumber);
                    var indicatorData = anychart.data.table(0);
                    indicatorData.addData(indicator.values);
                    var indicatorMapping = indicatorData.mapAs();
                ...
                var volumePlot = chart.plot(1 + plotNumber);
    ...
    tslib_1.__decorate([
        aurelia_framework_1.bindable,
        tslib_1.__metadata("design:type", Playgroundmodels.PlaygroundViewModel)
