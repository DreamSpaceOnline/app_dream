...
define('components/market/jobs-dashboard/jobs/job',["require", "exports", "tslib", "aurelia-framework", "../../../../services/account-service", "aurelia-event-aggregator"], function (require, exports, tslib_1, aurelia_framework_1, account_service_1, aurelia_event_aggregator_1) {
    "use strict";
    var Job = (function () {
        function Job(account, eventAggregator) {
            var _this = this;
            this.powerUser = false;
...
define('text!components/market/jobs-dashboard/jobs/job.html', ['module'], function(module) { module.exports = "<template><require from=\"./job.css\"></require><header><h3>${title}</h3></header></template>"; });
