...
define('components/market/jobs-dashboard/jobs/job',["require", "exports", "tslib", "aurelia-framework", "../../../../services/account-service", "../../../../services/job-service", "aurelia-event-aggregator", "../../../../common/types/job-models"], function (require, exports, tslib_1, aurelia_framework_1, account_service_1, job_service_1, aurelia_event_aggregator_1, job_models_1) {
    "use strict";
    var Job = (function () {
    ...
    var JobInfoExtentions = (function () {
        ...
        JobInfoExtentions.getJobStatusName = function (status) {
            switch (status) {
                ...
                case enums_1.JobStatus.Pending: return "Pending";
...
define('common/types/logs-models',["require", "exports"], function (require, exports) {
    "use strict";
});

define('services/job-service - Copy',["require", "exports", "tslib", "aurelia-framework", "aurelia-fetch-client", "../common/types/job-models"], function (require, exports, tslib_1, aurelia_framework_1, aurelia_fetch_client_1, job_models_1) {
    "use strict";
    var JobService = (function () {
        function JobService(http) {
            this.http = http;
