define('services/services-generated',["require", "exports", "tslib", "aurelia-framework", "aurelia-fetch-client"], function (require, exports, tslib_1, aurelia_framework_1, aurelia_fetch_client_1) {
    ...
    var StrategiesApiClient = (function () {
        ...
        StrategiesApiClient.prototype.validateTrade = function (model) {
            var _this = this;
            var url_ = this.baseUrl + "/api/strategy/validate-trade";
            url_ = url_.replace(/[?&]$/, "");
            var content_ = JSON.stringify(model ? model.toJSON() : null);
            var options_ = {
                body: content_,
            ...
            return this.http.fetch(url_, options_).then(function (_response) {
                return _this.processValidateTrade(_response);
            });
        };
        StrategiesApiClient.prototype.processValidateTrade = function (response) {
            var _this = this;
            var status = response.status;
            if (status === 200) {
                return response.text().then(function (responseText) {
                    var result200 = null;
                    var resultData200 = responseText === "" ? null : JSON.parse(responseText, _this.jsonParseReviver);
                    result200 = resultData200 ? ValidateTradeResult.fromJS(resultData200) : null;
                    return result200;
                });
            }
            else if (status !== 200 && status !== 204) {
    ...
    var TradeAccountApiClient = (function () {
        function TradeAccountApiClient(baseUrl, http) {
            this.jsonParseReviver = undefined;
            this.baseUrl = baseUrl ? baseUrl : "";
            this.http = http ? http : window;
        }
        TradeAccountApiClient.prototype.deposit = function (request) {
            var _this = this;
            var url_ = this.baseUrl + "/api/trade-account/deposit";
            url_ = url_.replace(/[?&]$/, "");
            var content_ = JSON.stringify(request ? request.toJSON() : null);
            var options_ = {
                body: content_,
            ...
            return this.http.fetch(url_, options_).then(function (_response) {
                return _this.processDeposit(_response);
            });
        };
        TradeAccountApiClient.prototype.processDeposit = function (response) {
            var status = response.status;
            if (status === 200) {
                return response.blob();
            }
        ...
        TradeAccountApiClient.prototype.withdraw = function (request) {
            var _this = this;
            var url_ = this.baseUrl + "/api/trade-account/withdraw";
            url_ = url_.replace(/[?&]$/, "");
            var content_ = JSON.stringify(request ? request.toJSON() : null);
            var options_ = {
                body: content_,
            ...
            return this.http.fetch(url_, options_).then(function (_response) {
                return _this.processWithdraw(_response);
            });
        };
        TradeAccountApiClient.prototype.processWithdraw = function (response) {
            var status = response.status;
            if (status === 200) {
                return response.blob();
            }
        ...
        TradeAccountApiClient.prototype.getAccounts = function () {
            var _this = this;
            var url_ = this.baseUrl + "/api/trade-account/all";
            url_ = url_.replace(/[?&]$/, "");
            var options_ = {
                method: "GET",
                headers: {
            ...
            return this.http.fetch(url_, options_).then(function (_response) {
                return _this.processGetAccounts(_response);
            });
        };
        TradeAccountApiClient.prototype.processGetAccounts = function (response) {
            var _this = this;
            var status = response.status;
            if (status === 200) {
                return response.text().then(function (responseText) {
        ...
        TradeAccountApiClient.prototype.createTrade = function (request) {
            var _this = this;
            var url_ = this.baseUrl + "/api/trade-account/create-trade";
            url_ = url_.replace(/[?&]$/, "");
            var content_ = JSON.stringify(request ? request.toJSON() : null);
            var options_ = {
                body: content_,
            ...
            return this.http.fetch(url_, options_).then(function (_response) {
                return _this.processCreateTrade(_response);
            });
        };
        TradeAccountApiClient.prototype.processCreateTrade = function (response) {
            var _this = this;
            var status = response.status;
            if (status === 200) {
                return response.text().then(function (responseText) {
                    var result200 = null;
                    var resultData200 = responseText === "" ? null : JSON.parse(responseText, _this.jsonParseReviver);
                    result200 = resultData200 ? AccountTradeModel.fromJS(resultData200) : null;
                    return result200;
                });
            }
            else if (status !== 200 && status !== 204) {
        ...
        TradeAccountApiClient.prototype.closeTrade = function (request) {
            var _this = this;
            var url_ = this.baseUrl + "/api/trade-account/close-trade";
            url_ = url_.replace(/[?&]$/, "");
            var content_ = JSON.stringify(request ? request.toJSON() : null);
            var options_ = {
                body: content_,
            ...
            return this.http.fetch(url_, options_).then(function (_response) {
                return _this.processCloseTrade(_response);
            });
        };
        TradeAccountApiClient.prototype.processCloseTrade = function (response) {
            var _this = this;
            var status = response.status;
            if (status === 200) {
                return response.text().then(function (responseText) {
        ...
        TradeAccountApiClient.prototype.closeTradePartially = function (request) {
            var _this = this;
            var url_ = this.baseUrl + "/api/trade-account/close-partially";
            url_ = url_.replace(/[?&]$/, "");
            var content_ = JSON.stringify(request ? request.toJSON() : null);
            var options_ = {
                body: content_,
            ...
            return this.http.fetch(url_, options_).then(function (_response) {
                return _this.processCloseTradePartially(_response);
            });
        };
        TradeAccountApiClient.prototype.processCloseTradePartially = function (response) {
            var _this = this;
            var status = response.status;
            if (status === 200) {
                return response.text().then(function (responseText) {
        ...
        TradeAccountApiClient.prototype.createAccount = function (request) {
            var _this = this;
            var url_ = this.baseUrl + "/api/trade-account/create-account";
            url_ = url_.replace(/[?&]$/, "");
            var content_ = JSON.stringify(request ? request.toJSON() : null);
            var options_ = {
                body: content_,
            ...
            return this.http.fetch(url_, options_).then(function (_response) {
                return _this.processCreateAccount(_response);
            });
        };
        TradeAccountApiClient.prototype.processCreateAccount = function (response) {
            var _this = this;
            var status = response.status;
            if (status === 200) {
                return response.text().then(function (responseText) {
                    var result200 = null;
                    var resultData200 = responseText === "" ? null : JSON.parse(responseText, _this.jsonParseReviver);
                    result200 = resultData200 ? AccountModel.fromJS(resultData200) : null;
                    return result200;
                });
            }
            else if (status !== 200 && status !== 204) {
        ...
        TradeAccountApiClient.prototype.getMaxRiskValue = function (accountId) {
            var _this = this;
            var url_ = this.baseUrl + "/api/trade-account/max-trade-risk/{accountId}";
            ...
            return this.http.fetch(url_, options_).then(function (_response) {
                return _this.processGetMaxRiskValue(_response);
            });
        };
        TradeAccountApiClient.prototype.processGetMaxRiskValue = function (response) {
            var _this = this;
            var status = response.status;
            if (status === 200) {
                return response.text().then(function (responseText) {
        ...
        TradeAccountApiClient.prototype.getOverallBalance = function (accountId) {
            var _this = this;
            var url_ = this.baseUrl + "/api/trade-account/overall-balance/{accountId}";
            if (accountId === undefined || accountId === null)
                throw new Error("The parameter 'accountId' must be defined.");
            url_ = url_.replace("{accountId}", encodeURIComponent("" + accountId));
            url_ = url_.replace(/[?&]$/, "");
            ...
            return this.http.fetch(url_, options_).then(function (_response) {
                return _this.processGetOverallBalance(_response);
            });
        };
        TradeAccountApiClient.prototype.processGetOverallBalance = function (response) {
            var _this = this;
            var status = response.status;
            if (status === 200) {
                return response.text().then(function (responseText) {
        ...
        TradeAccountApiClient.prototype.getBalanceFromTrades = function (accountId) {
            var _this = this;
            var url_ = this.baseUrl + "/api/trade-account/trade-balance/{accountId}";
            if (accountId === undefined || accountId === null)
                throw new Error("The parameter 'accountId' must be defined.");
            url_ = url_.replace("{accountId}", encodeURIComponent("" + accountId));
            url_ = url_.replace(/[?&]$/, "");
            ...
            return this.http.fetch(url_, options_).then(function (_response) {
                return _this.processGetBalanceFromTrades(_response);
            });
        };
        TradeAccountApiClient.prototype.processGetBalanceFromTrades = function (response) {
            var _this = this;
            var status = response.status;
            if (status === 200) {
                return response.text().then(function (responseText) {
        ...
        TradeAccountApiClient = tslib_1.__decorate([
            aurelia_framework_1.inject(String, aurelia_fetch_client_1.HttpClient),
            tslib_1.__metadata("design:paramtypes", [String, Object])
        ], TradeAccountApiClient);
        return TradeAccountApiClient;
    }());
    exports.TradeAccountApiClient = TradeAccountApiClient;
    ...
    var ValidateTradeRequest = (function () {
        ...
        ValidateTradeRequest.prototype.init = function (data) {
            if (data) {
            }
        };
        ValidateTradeRequest.fromJS = function (data) {
            var result = new ValidateTradeRequest();
            result.init(data);
            return result;
        };
        ValidateTradeRequest.prototype.toJSON = function (data) {
            data = typeof data === 'object' ? data : {};
            return data;
        };
    ...
    var ValidateTradeResult = (function () {
        function ValidateTradeResult(data) {
            if (data) {
                for (var property in data) {
                    if (data.hasOwnProperty(property))
                        this[property] = data[property];
        ...
        ValidateTradeResult.prototype.init = function (data) {
            if (data) {
                this.strategyId = data["strategyId"] !== undefined ? data["strategyId"] : null;
                this.strategyName = data["strategyName"] !== undefined ? data["strategyName"] : null;
        ...
        ValidateTradeResult.fromJS = function (data) {
            var result = new ValidateTradeResult();
            result.init(data);
            return result;
        };
        ValidateTradeResult.prototype.toJSON = function (data) {
            data = typeof data === 'object' ? data : {};
            data["strategyId"] = this.strategyId !== undefined ? this.strategyId : null;
            data["strategyName"] = this.strategyName !== undefined ? this.strategyName : null;
    ...
    exports.ValidateTradeResult = ValidateTradeResult;
    var RuleSetValidationResult = (function () {
        function RuleSetValidationResult(data) {
            if (data) {
                for (var property in data) {
                    if (data.hasOwnProperty(property))
                        this[property] = data[property];
        ...
        RuleSetValidationResult.prototype.init = function (data) {
            if (data) {
                this.ruleSetId = data["ruleSetId"] !== undefined ? data["ruleSetId"] : null;
                this.ruleSetName = data["ruleSetName"] !== undefined ? data["ruleSetName"] : null;
                this.isValid = data["isValid"] !== undefined ? data["isValid"] : null;
        ...
        RuleSetValidationResult.fromJS = function (data) {
            var result = new RuleSetValidationResult();
            result.init(data);
            return result;
        };
        RuleSetValidationResult.prototype.toJSON = function (data) {
            data = typeof data === 'object' ? data : {};
            data["ruleSetId"] = this.ruleSetId !== undefined ? this.ruleSetId : null;
            data["ruleSetName"] = this.ruleSetName !== undefined ? this.ruleSetName : null;
            data["isValid"] = this.isValid !== undefined ? this.isValid : null;
    ...
    exports.RuleSetValidationResult = RuleSetValidationResult;
    var RuleValidationResult = (function () {
        ...
        RuleValidationResult.prototype.init = function (data) {
            if (data) {
                this.ruleId = data["ruleId"] !== undefined ? data["ruleId"] : null;
                this.ruleName = data["ruleName"] !== undefined ? data["ruleName"] : null;
                this.isValid = data["isValid"] !== undefined ? data["isValid"] : null;
        ...
        RuleValidationResult.fromJS = function (data) {
            var result = new RuleValidationResult();
            result.init(data);
            return result;
        };
        RuleValidationResult.prototype.toJSON = function (data) {
            data = typeof data === 'object' ? data : {};
            data["ruleId"] = this.ruleId !== undefined ? this.ruleId : null;
            data["ruleName"] = this.ruleName !== undefined ? this.ruleName : null;
            data["isValid"] = this.isValid !== undefined ? this.isValid : null;
    ...
    exports.RuleValidationResult = RuleValidationResult;
    var DepositRequest = (function () {
        function DepositRequest(data) {
            if (data) {
                for (var property in data) {
                    if (data.hasOwnProperty(property))
                        this[property] = data[property];
        ...
        DepositRequest.prototype.init = function (data) {
            if (data) {
                this.accountId = data["accountId"] !== undefined ? data["accountId"] : null;
                this.amount = data["amount"] !== undefined ? data["amount"] : null;
                this.transferDate = data["transferDate"] ? new Date(data["transferDate"].toString()) : null;
            }
        };
        DepositRequest.fromJS = function (data) {
            var result = new DepositRequest();
            result.init(data);
            return result;
        };
        DepositRequest.prototype.toJSON = function (data) {
            data = typeof data === 'object' ? data : {};
            data["accountId"] = this.accountId !== undefined ? this.accountId : null;
            data["amount"] = this.amount !== undefined ? this.amount : null;
            data["transferDate"] = this.transferDate ? this.transferDate.toISOString() : null;
            return data;
        };
        return DepositRequest;
    }());
    exports.DepositRequest = DepositRequest;
    var WithdrawRequest = (function (_super) {
        tslib_1.__extends(WithdrawRequest, _super);
        function WithdrawRequest(data) {
            return _super.call(this, data) || this;
        }
        WithdrawRequest.prototype.init = function (data) {
            _super.prototype.init.call(this, data);
            if (data) {
            }
        };
        WithdrawRequest.fromJS = function (data) {
            var result = new WithdrawRequest();
            result.init(data);
            return result;
        };
        WithdrawRequest.prototype.toJSON = function (data) {
            data = typeof data === 'object' ? data : {};
            _super.prototype.toJSON.call(this, data);
            return data;
        };
    ...
    var AccountModel = (function () {
        ...
        AccountModel.prototype.init = function (data) {
            if (data) {
                this.accountId = data["accountId"] !== undefined ? data["accountId"] : null;
                this.name = data["name"] !== undefined ? data["name"] : null;
                this.userId = data["userId"] !== undefined ? data["userId"] : null;
                this.riskPerTrade = data["riskPerTrade"] !== undefined ? data["riskPerTrade"] : null;
                this.riskPerMonth = data["riskPerMonth"] !== undefined ? data["riskPerMonth"] : null;
            }
        };
        AccountModel.fromJS = function (data) {
            var result = new AccountModel();
            result.init(data);
            return result;
        };
        AccountModel.prototype.toJSON = function (data) {
            data = typeof data === 'object' ? data : {};
            data["accountId"] = this.accountId !== undefined ? this.accountId : null;
            data["name"] = this.name !== undefined ? this.name : null;
            data["userId"] = this.userId !== undefined ? this.userId : null;
            data["riskPerTrade"] = this.riskPerTrade !== undefined ? this.riskPerTrade : null;
            data["riskPerMonth"] = this.riskPerMonth !== undefined ? this.riskPerMonth : null;
            return data;
        };
        return AccountModel;
    }());
    exports.AccountModel = AccountModel;
    var CreateTradeRequest = (function () {
        function CreateTradeRequest(data) {
            if (data) {
                for (var property in data) {
                    if (data.hasOwnProperty(property))
                        this[property] = data[property];
        ...
        CreateTradeRequest.prototype.init = function (data) {
            if (data) {
                this.accountId = data["accountId"] !== undefined ? data["accountId"] : null;
                this.entryDate = data["entryDate"] ? new Date(data["entryDate"].toString()) : null;
                this.entryPrice = data["entryPrice"] !== undefined ? data["entryPrice"] : null;
        ...
        CreateTradeRequest.fromJS = function (data) {
            var result = new CreateTradeRequest();
            result.init(data);
            return result;
        };
        CreateTradeRequest.prototype.toJSON = function (data) {
            data = typeof data === 'object' ? data : {};
            data["accountId"] = this.accountId !== undefined ? this.accountId : null;
            data["entryDate"] = this.entryDate ? this.entryDate.toISOString() : null;
            data["entryPrice"] = this.entryPrice !== undefined ? this.entryPrice : null;
    ...
    var AccountTradeModel = (function () {
        function AccountTradeModel(data) {
            if (data) {
                for (var property in data) {
                    if (data.hasOwnProperty(property))
                        this[property] = data[property];
        ...
        AccountTradeModel.prototype.init = function (data) {
            if (data) {
                this.tradeId = data["tradeId"] !== undefined ? data["tradeId"] : null;
                this.accountId = data["accountId"] !== undefined ? data["accountId"] : null;
                this.entryPrice = data["entryPrice"] !== undefined ? data["entryPrice"] : null;
                this.direction = data["direction"] !== undefined ? data["direction"] : null;
                this.entryDate = data["entryDate"] ? new Date(data["entryDate"].toString()) : null;
                this.closeDate = data["closeDate"] ? new Date(data["closeDate"].toString()) : null;
                this.sharesCount = data["sharesCount"] !== undefined ? data["sharesCount"] : null;
                this.closePrice = data["closePrice"] !== undefined ? data["closePrice"] : null;
            }
        };
        AccountTradeModel.fromJS = function (data) {
            var result = new AccountTradeModel();
            result.init(data);
            return result;
        };
        AccountTradeModel.prototype.toJSON = function (data) {
            data = typeof data === 'object' ? data : {};
            data["tradeId"] = this.tradeId !== undefined ? this.tradeId : null;
            data["accountId"] = this.accountId !== undefined ? this.accountId : null;
            data["entryPrice"] = this.entryPrice !== undefined ? this.entryPrice : null;
            data["direction"] = this.direction !== undefined ? this.direction : null;
            data["entryDate"] = this.entryDate ? this.entryDate.toISOString() : null;
            data["closeDate"] = this.closeDate ? this.closeDate.toISOString() : null;
            data["sharesCount"] = this.sharesCount !== undefined ? this.sharesCount : null;
            data["closePrice"] = this.closePrice !== undefined ? this.closePrice : null;
            return data;
        };
        return AccountTradeModel;
    }());
    exports.AccountTradeModel = AccountTradeModel;
    var CloseTradeRequest = (function () {
        function CloseTradeRequest(data) {
            if (data) {
                for (var property in data) {
                    if (data.hasOwnProperty(property))
                        this[property] = data[property];
        ...
        CloseTradeRequest.prototype.init = function (data) {
            if (data) {
                this.accountId = data["accountId"] !== undefined ? data["accountId"] : null;
                this.tradeId = data["tradeId"] !== undefined ? data["tradeId"] : null;
                this.closeDate = data["closeDate"] ? new Date(data["closeDate"].toString()) : null;
        ...
        CloseTradeRequest.fromJS = function (data) {
            var result = new CloseTradeRequest();
            result.init(data);
            return result;
        };
        CloseTradeRequest.prototype.toJSON = function (data) {
            data = typeof data === 'object' ? data : {};
            data["accountId"] = this.accountId !== undefined ? this.accountId : null;
            data["tradeId"] = this.tradeId !== undefined ? this.tradeId : null;
            data["closeDate"] = this.closeDate ? this.closeDate.toISOString() : null;
    ...
    exports.CloseTradeRequest = CloseTradeRequest;
    var CloseTradePartiallyRequest = (function (_super) {
        tslib_1.__extends(CloseTradePartiallyRequest, _super);
        function CloseTradePartiallyRequest(data) {
            return _super.call(this, data) || this;
        }
        CloseTradePartiallyRequest.prototype.init = function (data) {
            _super.prototype.init.call(this, data);
            if (data) {
                this.sharesCount = data["sharesCount"] !== undefined ? data["sharesCount"] : null;
            }
        };
        CloseTradePartiallyRequest.fromJS = function (data) {
            var result = new CloseTradePartiallyRequest();
            result.init(data);
            return result;
        };
        CloseTradePartiallyRequest.prototype.toJSON = function (data) {
            data = typeof data === 'object' ? data : {};
            data["sharesCount"] = this.sharesCount !== undefined ? this.sharesCount : null;
            _super.prototype.toJSON.call(this, data);
            return data;
        };
        return CloseTradePartiallyRequest;
    }(CloseTradeRequest));
    exports.CloseTradePartiallyRequest = CloseTradePartiallyRequest;
    var CreateAccountRequest = (function () {
        ...
        CreateAccountRequest.prototype.init = function (data) {
            if (data) {
                this.accountName = data["accountName"] !== undefined ? data["accountName"] : null;
                this.userId = data["userId"] !== undefined ? data["userId"] : null;
                this.riskPerTrade = data["riskPerTrade"] !== undefined ? data["riskPerTrade"] : null;
        ...
        CreateAccountRequest.fromJS = function (data) {
            var result = new CreateAccountRequest();
            result.init(data);
            return result;
        };
        CreateAccountRequest.prototype.toJSON = function (data) {
            data = typeof data === 'object' ? data : {};
            data["accountName"] = this.accountName !== undefined ? this.accountName : null;
            data["userId"] = this.userId !== undefined ? this.userId : null;
            data["riskPerTrade"] = this.riskPerTrade !== undefined ? this.riskPerTrade : null;
...
define('components/journal/journals/journal-create/journal-create',["require", "exports", "tslib", "aurelia-framework", "aurelia-validation", "../../../../common/helpers/enum-helper", "../../../../services/services-generated", "../../../../form-validation/bootstrap-form-renderer"], function (require, exports, tslib_1, aurelia_framework_1, aurelia_validation_1, enum_helper_1, services_generated_1, bootstrap_form_renderer_1) {
    ...
    var JournalCreate = (function () {
        function JournalCreate(validation, accountService, strategiesService, ruleSetService) {
            this.validation = validation;
        ...
        JournalCreate.prototype.activate = function () {
            return tslib_1.__awaiter(this, void 0, void 0, function () {
                var _a, _b;
                return tslib_1.__generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            _a = this;
                            return [4, this.accountService.getAccounts()];
                        case 1:
                            _a.accounts = _c.sent();
                            _b = this;
                            return [4, this.strategiesService.geStrategySummaries()];
                        case 2:
                            _b.strategies = _c.sent();
                            return [2];
                    }
                });
            });
        ...
        JournalCreate.prototype.onAccountSelected = function (accountId) {
            return tslib_1.__awaiter(this, void 0, void 0, function () {
                return tslib_1.__generator(this, function (_a) {
                    this.account = null;
                    if (accountId && accountId > 0) {
                        this.account = this.accounts.find(function (item) { return item.accountId === accountId; });
                    }
                    return [2];
                });
            });
        };
        JournalCreate.prototype.onStrategySelected = function (strategyId) {
            return tslib_1.__awaiter(this, void 0, void 0, function () {
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            this.strategy = null;
                            if (!(strategyId && strategyId > 0)) return [3, 2];
                            this.strategy = this.strategies.find(function (item) { return item.strategyId === strategyId; });
                            if (!(this.strategy != null)) return [3, 2];
                            return [4, this.loadStrategyRules(strategyId)];
                        case 1:
                            _a.sent();
                            _a.label = 2;
                        case 2: return [2];
        ...
        JournalCreate.prototype.loadStrategyRules = function (strategyId) {
            return tslib_1.__awaiter(this, void 0, void 0, function () {
                var _this = this;
                var ruleSets;
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            this.ruleSets = [];
                            if (!(strategyId > 0)) return [3, 2];
                            return [4, this.ruleSetService.getStrategyRuleSets(strategyId)];
                        case 1:
                            ruleSets = _a.sent();
                            if (ruleSets && ruleSets.length > 0) {
                                ruleSets.forEach(function (item) {
                                    var ruleset = new services_generated_1.RuleSetValidationResult();
                                    ruleset.ruleSetId = item.ruleSetId;
                                    ruleset.ruleSetName = item.ruleSetName;
                                    _this.ruleSets.push(ruleset);
                                });
                            }
                            _a.label = 2;
                        case 2: return [2];
        ...
        JournalCreate = tslib_1.__decorate([
            ...
            tslib_1.__metadata("design:paramtypes", [aurelia_validation_1.ValidationController,
                services_generated_1.TradeAccountApiClient,
                services_generated_1.StrategiesApiClient,
                services_generated_1.RuleSetsApiClient])
        ], JournalCreate);
...
define('text!components/journal/journals/journal-create/journal-create.html', ['module'], function(module) { module.exports = "<template><require from=\"./journal-create.css\"></require><require from=\"../company-details/company-details\"></require><div class=\"journal-create\"><header><h3>Create journal entry</h3></header><form submit.delegate=\"trySaveJournal()\"><fieldset><div class=\"row\"><div class=\"form-inline col-xs-12\"><div class=\"form-group\"><label for=\"txtTicker\">Ticker</label><input type=\"text\" class=\"form-control ticker\" id=\"txtTicker\" value.bind=\"journal.ticker & validate\"></div><div class=\"form-group\"><label for=\"ddlDirection\">Direction:</label><select id=\"ddlDirection\" class=\"form-control\" value.bind=\"journal.tradeDirection\"><option repeat.for=\"direction of directions\" model.bind=\"direction.id\">${direction.name}</option></select></div><div class=\"form-group\"><label for=\"txtDate\">Entry Date:</label><abp-datetime-picker model.bind=\"journal.entryDate & validate\" id=\"txtDate\" element.bind=\"entryDatePicker\"></abp-datetime-picker></div></div></div><div if.bind=\"journal.ticker.length > 0\"><h5>Company Information</h5><div class=\"company-details\"><company-details ticker.bind=\"journal.ticker\"></company-details></div><div class=\"row\"><div class=\"form-inline col-xs-12\"><div class=\"form-group\"><label for=\"ddlAccount\">Account:</label><select id=\"ddlAccount\" class=\"form-control\" value.bind=\"journal.accountId\" change.delegate=\"onAccountSelected(journal.accountId)\"><option>- Select Account -</option><option repeat.for=\"account of accounts\" model.bind=\"account.accountId\">${account.name}</option></select></div><div class=\"form-group\" if.bind=\"journal.accountId > 0\"><label for=\"txtRiskPerTrade\">Risk per trade (%)</label><p class=\"form-control\" id=\"txtRiskPerTrade\" readonly=\"readonly\">${account.riskPerTrade}%</p></div><div class=\"form-group\" if.bind=\"journal.accountId > 0\"><label for=\"txtRiskPerMonth\">Risk per month (%)</label><p class=\"form-control\" id=\"txtRiskPerMonth\" readonly=\"readonly\">${account.riskPerMonth}%</p></div></div></div><div if.bind=\"journal.accountId > 0\"><div class=\"row\"><div class=\"col-xs-4\"><h5>Trade setup</h5><div class=\"form-horizontal\"><div class=\"form-group\"><label for=\"txtEntryPrice\" class=\"col-sm-4 control-label\">Entry price:</label><div class=\"col-sm-6\"><input type=\"text\" class=\"form-control\" id=\"txtEntryPrice\" value.bind=\"journal.entryPrice & validate\"></div></div><div class=\"form-group\"><label for=\"txtTargetPrice\" class=\"col-sm-4 control-label\">Target price:</label><div class=\"col-sm-6\"><input type=\"text\" class=\"form-control\" id=\"txtTargetPrice\" value.bind=\"journal.takeProfitPrice & validate\"></div></div><div class=\"form-group\"><label for=\"txtStopPrice\" class=\"col-sm-4 control-label\">Stop loss price:</label><div class=\"col-sm-6\"><input type=\"text\" class=\"form-control\" id=\"txtStopPrice\" value.bind=\"journal.stopLossPrice & validate\"></div></div></div></div><div class=\"col-xs-4\"><h5>Risk management</h5><div class=\"form-horizontal\"><div class=\"form-group\"><label for=\"txtRiskValue\" class=\"col-sm-5 control-label\">Risk value($):</label><div class=\"col-sm-6\"><input type=\"text\" class=\"form-control\" id=\"txtRiskValue\" value.bind=\"journal.maxRiskValuePrice & validate\"></div></div><div class=\"form-group\"><label for=\"txtRewardRatio\" class=\"col-sm-5 control-label\">Reward / Risk ratio:</label><div class=\"col-sm-6\"><input type=\"text\" class=\"form-control\" readonly=\"readonly\" id=\"txtRewardRatio\" value.bind=\"journal.rewardRiskRatio & validate\"></div></div><div class=\"form-group\"><label for=\"txtMaxShares\" class=\"col-sm-5 control-label\">Max shares count:</label><div class=\"col-sm-6\"><input type=\"text\" class=\"form-control\" readonly=\"readonly\" id=\"txtMaxShares\" value.bind=\"journal.maxSharesCount & validate\"></div></div></div></div><div class=\"col-xs-4\"><h5>Risk limits</h5><div class=\"form-horizontal\"><div class=\"form-group\"><label for=\"txtMaxRiskPerTrade\" class=\"col-sm-5 control-label\">Max risk per trade($):</label><div class=\"col-sm-6\"><input type=\"text\" class=\"form-control\" id=\"txtMaxRiskPerTrade\" readonly=\"readonly\" value.bind=\"maxRiskPerTrade\"></div></div><div class=\"form-group\"><label for=\"txtMaxRiskPerMonth\" class=\"col-sm-5 control-label\">Max risk per month($)</label><div class=\"col-sm-6\"><input type=\"text\" class=\"form-control\" readonly=\"readonly\" id=\"txtMaxRiskPerMonth\" value.bind=\"maxRiskPerMonth\"></div></div><div class=\"form-group\"><label for=\"txtMaxSharesCount\" class=\"col-sm-5 control-label\">Max Shares to trade</label><div class=\"col-sm-6\"><input type=\"text\" class=\"form-control\" readonly=\"readonly\" id=\"txtMaxSharesCount\" value.bind=\"maxSharesCount\"></div></div></div></div></div><h4>Strategy Information</h4><div class=\"row\"><div class=\"form-horizontal\"><div class=\"form-group\"><label class=\"col-sm-4 control-label\" for=\"ddlStrategy\">Select Strategy:</label><div class=\"col-sm-6\"><select id=\"ddlStrategy\" class=\"form-control\" value.bind=\"journal.strategyId\" change.delegate=\"onStrategySelected(journal.strategyId)\"><option>- Select Strategy -</option><option repeat.for=\"s of strategies\" model.bind=\"s.strategyId\">${s.title}</option></select></div></div><div class=\"form-group\"><label class=\"col-sm-4 control-label\">Summary:</label><div class=\"col-sm-6\"><p class=\"form-control\">${strategy.summary}</p></div></div></div></div><h4>Strategy Rules</h4><div class=\"row\"><div class=\"form-horizontal\"><div class=\"form-group\" repeat.for=\"ruleSet of ruleSets\"><label class=\"col-sm-6 control-label\">Rule:</label><div class=\"col-sm-5\"><p type=\"text\" class=\"form-control\">${ruleSet.ruleSetName}}</p></div></div></div></div></div></div></fieldset><div class=\"c_journal-actions\"><button type=\"submit\" class=\"btn btn-danger\" if.bind=\"journal.ticker.length > 0\">Save</button> <button type=\"button\" click.delegate=\"cancelEdit()\" class=\"btn btn-default\">Cancel</button></div></form></div></template>"; });
