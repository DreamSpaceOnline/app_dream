...
define('common/types/layout-models',["require", "exports"], function (require, exports) {
    "use strict";
...
define('services/layout-service',["require", "exports", "tslib", "aurelia-framework", "aurelia-fetch-client", "../common/helpers/enum-helper"], function (require, exports, tslib_1, aurelia_framework_1, aurelia_fetch_client_1, enum_helper_1) {
    "use strict";
    var LayoutService = (function () {
        ...
        LayoutService.prototype.getLayouts = function (periodUrl) {
            return tslib_1.__awaiter(this, void 0, void 0, function () {
                var period, response;
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            period = enum_helper_1.EnumValues.getQuotePeriod(periodUrl).id;
                            return [4 /*yield*/, this.http.fetch("layout/period/" + period, { method: "get" })];
                        case 1:
                            response = _a.sent();
                            return [4 /*yield*/, response.json()];
                        case 2: return [2 /*return*/, _a.sent()];
        ...
        LayoutService.prototype.getDefaultLayout = function (periodUrl) {
            return tslib_1.__awaiter(this, void 0, void 0, function () {
                var period, response;
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            period = enum_helper_1.EnumValues.getQuotePeriod(periodUrl).id;
                            return [4 /*yield*/, this.http.fetch("layout/period/" + period + "/default", { method: "get" })];
                        case 1:
                            response = _a.sent();
                            return [4 /*yield*/, response.json()];
                        case 2: return [2 /*return*/, _a.sent()];
...
define('resources/elements/navigation/sub-nav',["require", "exports", "tslib", "aurelia-framework", "aurelia-router"], function (require, exports, tslib_1, aurelia_framework_1, aurelia_router_1) {
    ...
    tslib_1.__decorate([
        aurelia_framework_1.bindable,
        tslib_1.__metadata("design:type", aurelia_router_1.Router)
    ], SubtNav.prototype, "router", void 0);
    exports.SubtNav = SubtNav;
});
...
define('components/market/chart-layouts/layouts/chart-layout',["require", "exports", "tslib", "aurelia-framework", "../../../../services/account-service", "../../../../services/layout-service", "aurelia-event-aggregator"], function (require, exports, tslib_1, aurelia_framework_1, account_service_1, layout_service_1, aurelia_event_aggregator_1) {
    "use strict";
    var ChartLayout = (function () {
        function ChartLayout(account, eventAggregator, layoutService) {
            var _this = this;
        ...
        ChartLayout.prototype.onNavigatioComplete = function () {
            this.title = this.router.currentInstruction.config.title;
            this.layoutUrl = this.router.currentInstruction.config.name;
            this.loadLayouts();
        };
        ChartLayout.prototype.activate = function (params, routeconfig, navigationInstruction) {
            this.router = navigationInstruction.router;
        ...
        ChartLayout.prototype.loadLayouts = function () {
            return tslib_1.__awaiter(this, void 0, void 0, function () {
                var _a;
                return tslib_1.__generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            _a = this;
                            return [4 /*yield*/, this.layoutService.getLayouts(this.layoutUrl)];
                        case 1:
                            _a.layouts = _b.sent();
                            return [2 /*return*/];
                    }
    ...
    ChartLayout = tslib_1.__decorate([
        aurelia_framework_1.autoinject(),
        tslib_1.__metadata("design:paramtypes", [account_service_1.AccountService, aurelia_event_aggregator_1.EventAggregator, layout_service_1.LayoutService])
    ], ChartLayout);
    ...
    var Job = (function () {
        ...
        Job.prototype.loadJobs = function () {
            return tslib_1.__awaiter(this, void 0, void 0, function () {
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.loadCurrentJob()];
                        case 1:
                            _a.sent();
        ...
        Job.prototype.watchCurrentJob = function () {
            return tslib_1.__awaiter(this, void 0, void 0, function () {
                ...
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            if (!(this.currentJob != null && this.currentJob.jobId > 0)) return [3 /*break*/, 1];
                            ...
                            return [3 /*break*/, 3];
                        case 1: return [4 /*yield*/, this.loadHistory()];
                        case 2:
                            _a.sent();
                            _a.label = 3;
                        case 3: return [2 /*return*/];
                ...
                return tslib_1.__generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            if (!(this.expanded && this.jobLogs != null && this.jobLogs.length === 0 && this.job != null)) return [3 /*break*/, 2];
                            _a = this;
                            return [4 /*yield*/, this.logService.getJobLogs(this.job.jobId)];
                        case 1:
                            _a.jobLogs = _b.sent();
                            _b.label = 2;
                        case 2: return [2 /*return*/];
        ...
        JobDetails.prototype.delete = function () {
            return tslib_1.__awaiter(this, void 0, void 0, function () {
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            if (!(this.job != null && this.job.jobId > 0)) return [3 /*break*/, 3];
...
define('text!components/market/chart-layouts/layouts/chart-layout.html', ['module'], function(module) { module.exports = "<template><require from=\"../chart-layouts.css\"></require><header><h3>${title}</h3></header></template>"; });
...
define('text!components/market/chart-layouts/chart-layouts.css', ['module'], function(module) { module.exports = ""; });
